...
<head>
    ...
    <!--title-->
    <title>LogIn-Dependable Staffing Agency</title>
                        ...
                        <form class="login-signup-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input id="email" type="email" class="form-control form-pd @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="name@yourdomain.com">
                                    @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input id="password" type="password" class="form-control form-pd @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter your password">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
